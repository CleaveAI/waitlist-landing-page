...
export const EvaluationAnimation: FC<EvaluationAnimationProps> = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        'relative bg-gradient-to-br from-neutral-900/80 via-neutral-800/60 to-neutral-900/80 backdrop-blur-xl border border-neutral-700/50 rounded-3xl p-6 sm:p-8 max-w-3xl w-full shadow-2xl h-full',
        className
      )}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-neutral-200/10 to-white/10 rounded-3xl blur-xl"></div>
      <div className="relative h-full flex flex-col">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            <div className="flex items-center space-x-3 font-clash">
              ...
              <div>
                ...
                {isOptimizing && (
                  <div className="flex items-center space-x-1 text-neutral-300 mt-1">
                    <div className="w-2 h-2 border border-neutral-300 border-t-transparent rounded-full animate-spin"></div>
        ...
        <div className="bg-neutral-950/70 border border-neutral-700/50 rounded-xl overflow-hidden flex-1 flex flex-col">
          <div className="flex items-center justify-between px-4 py-2 bg-neutral-800/50 border-b border-neutral-700/50">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-neutral-400 ml-3">system_prompt.txt</span>
            </div>
            <div className="text-xs text-neutral-500">{isTyping ? 'Editing...' : 'Ready'}</div>
          </div>

          <div className="p-4 font-mono text-sm h-full overflow-y-auto">
            <div className="flex items-start space-x-3">
              <div className="text-neutral-500 text-xs pt-0.5">1</div>
